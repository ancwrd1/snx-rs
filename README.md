...
| `No CCC session in reply!`                                        | Usually happens when Check Point server runs out of client licenses. Try the `client-mode` parameter with different values: `endpoint_security`, `secure_remote`, `secure_connect` | 
