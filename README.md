...
| `failed to fill whole buffer`                                     | Some incoming IPSec UDP packets are blocked by the firewall or the router. Could be related to the blocking of the larger (fragmented) UDP packets.                                      |
