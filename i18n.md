...
* Remove entries from the locale files are no longer present in the base file.
...
* Prefer efficient task execution via local Python scripts rather than consuming all translation files. 
