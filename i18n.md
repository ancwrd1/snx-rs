...
Every file also contains the entries which represent the supported locales, which start with `lang-` prefix. For example: `language-en-US`, `language-de-DE`, etc. The base file for translation is `en-US/main.ftl` which contains English strings.
