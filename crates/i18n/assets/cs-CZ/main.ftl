...
cli-mobile-access-auth = Pro ověření mobilního přístupu se přihlaste pomocí následujícího odkazu, poté najděte heslo uživatele v hexadecimálním tvaru ve zdrojovém kódu stránky a zadejte ho sem:
