...
label-no-split-dns = Désactiver le DNS partagé pour systemd-resolved
...
label-client-cert = Fichier de certificat client
label-driver-file = Fichier de pilote PKCS11
...
label-supported-files = Types de fichiers pris en charge
...
error-profile-not-found = Profil introuvable : {$profile}
...
info-transport-type = Type de transport IPsec
...
info-ike-expiration = Expiration de la SA IKE
