...
For macOS, install the Homebrew [formula](https://github.com/Homebrew/homebrew-core/commit/2cf2161a878a00504b93090fe1f722787a9ea0b3) or use the `.dmg` package from the release page (see below).<br/>
